function pageLoad() {
  ...
  passenger1Name = `${ride[0].passengerDetails.first} ${ride[0].passengerDetails.last}`, passenger1Phone = ride[0].passengerDetails.phoneNumber, passenger1NumberOfPassengers = ride[0].numberOfPassengers
  ...
  passenger2Name = `${ride[1].passengerDetails.first} ${ride[1].passengerDetails.last}`, passenger2Phone = ride[1].passengerDetails.phoneNumber, passenger2NumberOfPassengers = ride[1].numberOfPassengers
  ...
  passenger3Name = `${ride[2].passengerDetails.first} ${ride[2].passengerDetails.last}`, passenger3Phone = ride[2].passengerDetails.phoneNumber, passenger3NumberOfPassengers = ride[2].numberOfPassengers
